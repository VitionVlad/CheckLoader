...
void TFT9341_Draw8(uint16_t x, uint16_t y, uint8_t color){
	switch(color){
	case 1:
		TFT9341_DrawPixel(x, y, TFT9341_WHITE);
		break;
	default:
		TFT9341_DrawPixel(x, y, TFT9341_BLACK);
		break;
	}
}
...
void TFT9341_DrawMassive8(uint8_t *mimage, uint16_t orientation){
	uint16_t currcolnum = 0;
	uint16_t x = 0;
	for(uint16_t y = 0; y != TFT9341_HEIGHT;y++){
		for(; x != TFT9341_HEIGHT;x++){
			switch(orientation){
			case 0:
				TFT9341_Draw8(TFT9341_WIDTH-x, y, mimage[currcolnum]);
				break;
			case 1:
				TFT9341_Draw8(y, x, mimage[currcolnum]);
				break;
			case 2:
				TFT9341_Draw8(TFT9341_WIDTH-y, TFT9341_HEIGHT-x, mimage[currcolnum]);
				break;
			case 3:
				TFT9341_Draw8(x, TFT9341_HEIGHT-y, mimage[currcolnum]);
				break;
			}
			currcolnum++;
		}
...
int main(void)
{
  ...
  TFT9341_DrawMassive8(bootsplash, 1);
